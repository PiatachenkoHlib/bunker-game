...
export const GameEvents = {
    ...
    descript: new Event("ДЕШИФРУВАННЯ", "На цьому раунді замок змінює логіку. Замість загальної індикації, він детально розбирає кожну цифру — яка на своєму місці, яка ні, якої взагалі немає.", () => {
